...
assert.equal(competition.players.length, 14, "Expected all 14 competition players");
assert.equal(new Set(competition.players.map((player) => player.name)).size, 14, "Player names must be unique");
