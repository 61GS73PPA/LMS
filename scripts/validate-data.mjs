...
assert.equal(competition.players.length, 19, "Expected all 19 competition players");
...
assert.equal(competition.players.filter((player) => player.status === "alive").length, 15, "Expected 15 Gameweek 2 survivors");
assert.deepEqual(
